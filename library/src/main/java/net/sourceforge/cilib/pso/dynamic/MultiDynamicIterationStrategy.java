 ...
 */
public class MultiDynamicIterationStrategy implements IterationStrategy<PSO> {
    ...
    /**
     * Create a new instance of {@linkplain MultiDynamicIterationStrategy}.
     * <p>
     ...
     */
    public MultiDynamicIterationStrategy() {
     ...
     */
    public MultiDynamicIterationStrategy(MultiDynamicIterationStrategy copy) {
     ...
     */
    @Override
    public MultiDynamicIterationStrategy getClone() {
        return new MultiDynamicIterationStrategy(this);
    }
